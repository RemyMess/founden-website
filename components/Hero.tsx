  ...
  return (
    <section className="relative max-w-7xl mx-auto flex flex-col lg:flex-row items-center justify-center gap-16 lg:gap-20 px-8 py-8 lg:py-20">
        ...
        <div className="flex flex-col gap-10 lg:gap-14 items-center justify-center text-center lg:text-left lg:items-start">
          ...
          <h1 className="font-extrabold text-4xl lg:text-6xl tracking-tight md:-mb-4 text-orange-500" style={{ fontFamily: "'Press Start 2P', sans-serif" }}> */}
           
          {/* <link href="https://fonts.googleapis.com/css2?family=Chelsea+Market&family=Press+Start+2P&family=Rubik+Doodle+Shadow&display=swap" rel="stylesheet"/>
          <h1 className="font-extrabold text-4xl lg:text-6xl tracking-tight md:-mb-4 text-orange-500" style={{ fontFamily: "Chelsea Market', cursive" }}> */}
          
          {/* <link href="https://fonts.googleapis.com/css2?family=Chelsea+Market&family=Londrina+Outline&family=Press+Start+2P&family=Rubik+Doodle+Shadow&display=swap" rel="stylesheet"/>
          <h1 className="font-extrabold text-4xl lg:text-6xl tracking-tight md:-mb-4 text-orange-500" style={{ fontFamily: "'Londrina Outline', sans-serif" }}> */}

          {/* <link href="https://fonts.googleapis.com/css2?family=Chelsea+Market&family=Londrina+Outline&family=Press+Start+2P&family=Rubik+Doodle+Shadow&family=VT323&display=swap" rel="stylesheet"/>
